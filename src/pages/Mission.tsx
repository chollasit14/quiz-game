...
const MISSIONS = [
  {
    id: 1,
    name: "ภารกิจที่ 1: จับจุดเสี่ยงพื้นฐาน",
    startDate: new Date("2025-12-01T00:00:00"),
    endDate: new Date("2025-12-07T23:59:59"),
    icon: "🔍",
    color: "mission-1"
  },
  {
    id: 2,
    name: "ภารกิจที่ 2: ตรวจสอบขั้นสูง",
    startDate: new Date("2025-12-01T00:00:00"),
    endDate: new Date("2025-12-14T23:59:59"),
    icon: "🎯",
    color: "mission-2"
  },
  {
    id: 3,
    name: "ภารกิจที่ 3: ท้าทายสุดขีด",
    startDate: new Date("2025-12-01T00:00:00"),
    ...
    <div className="mission-container">
      <div className="mission-content">
        <div className="mission-header">
          <h1>ยินดีต้อนรับ {employeeName}</h1>
